...
* `'use strict';` or strict mode, enables more warnings and forces you to use a cleaner syntax. It can be declared at the top of a document or inside a function body.
